  ...
  const data = [
    {
      ...
      "image": "//spiruswastha.com/cdn/shop/files/ayurvedic_Products_1.svg?v=1733747320&width=100"
    },
    {
      "title": "Lifestyle Recommendations",
      "text": "Complement it with yoga asanas for maximum benefit",
      "image": "//spiruswastha.com/cdn/shop/files/yoga-pose_4941620_1.svg?v=1733747597&width=100"
    },
    {
      "title": "Wellness Tips",
      "text": "Blogs on Daily Ayurvedic self-care practices to enhance well-being.",
      "image": "//spiruswastha.com/cdn/shop/files/garden-location_18861819_2.svg?v=1740049294&width=100"
    },
    {
      "title": "Free Consultation",
      "text": "Get in touch with our expert for personalized guidance",
      "image": "//spiruswastha.com/cdn/shop/files/Expert_Connect_1_c88fb280-6826-4668-85c4-1705915eb957.svg?v=1735022925&width=100"
    }
  ]
...
<div className='mb-[6.25rem] mt-[3.125rem]' >
    <div className="w-full max-w-[1440px]  mx-auto text-center px-[15px]">
      ...
      <div className="max-w-[9.375rem] h-0.5 bg-[#018d43] mx-auto  mt-[12px] mb-[15px]" data-aos="fade-up" data-aos-duration="2000" data-aos-offset="10" data-aos-once="false" data-aos-delay="1000"></div>
        ...
        {data.map((x)=>{
                return (
                    <div className="flex flex-col items-center text-center px-[15px] mt-[1.875rem] bg-white" data-aos="fade-up" data-aos-duration="2000" data-aos-offset="10" data-aos-once="false" data-aos-delay="1000">
