  ...
  const data = [
    {
      ...
      price_value: 1070,
      image:
        "https://spiruswastha.com/cdn/shop/files/1_de5eda8d-7c0c-4f35-becd-9007ba88ec2e.jpg?v=1740032196",
    },
    {
      ...
      price_value: 1590,
      image:
        "https://spiruswastha.com/cdn/shop/files/2_320ff308-c8f8-4927-8f15-75a0aad7e6eb.jpg?v=1740032248",
    },
    {
      ...
      price_value: 799,
      image:
        "https://spiruswastha.com/cdn/shop/files/3_1481e07a-f922-4937-bee0-35b7e8a5ece8.jpg?v=1740032336",
    },
    {
      ...
      price_value: 1199,
      image:
        "https://spiruswastha.com/cdn/shop/files/4_4bd5bd52-251b-4588-8ecd-322f420905bb.jpg?v=1740032430",
    },
    {
      ...
      price_value: 839,
      image:
        "https://spiruswastha.com/cdn/shop/files/5_48c6fcf3-1b02-44e7-85ec-73d67f5a0218.jpg?v=1740032956",
    },
    {
    ...
    },
    {
      ...
      price_value: 700,
      image:
        "https://spiruswastha.com/cdn/shop/files/7_bb03f006-448a-435a-90dd-881c909ea7a9.jpg?v=1740027300",
    },
    {
      ...
      price_value: 569,
      image:
        "https://spiruswastha.com/cdn/shop/files/8_f06ae11b-8d89-4883-b9d0-c386d1bcf783.jpg?v=1740027309",
    },
  ];
  ...
  return (
    <div className="mb-[9.375rem]">
      <div className="w-full max-w-[1440px]  mx-auto text-center px-[15px]">
        ...
        >
          {data.map((x, index) => (
            <ProductCard title={x.title} image={x.image} price={x.price} />
          ))}
        </div>
      </div>
    </div>
