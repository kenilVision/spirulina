...
function SummerWellnessCombos() {
  ...
  useEffect(() => {
    ...
    <div className="w-full max-w-[1440px]  mx-auto text-center px-[15px]">
      ...
      <p className="text-gray-600 mt-4 max-w-2xl mx-auto mb-[30px]" data-aos="fade-up" data-aos-duration="2000" data-aos-offset="10" data-aos-once="false" data-aos-delay="1000" >
