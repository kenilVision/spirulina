...
function TextContent() {
    ...
    <>
      ...
      >
        ...
        <div className='flex flex-col justify-center items-start'>
          ...
          <h3
            className=" text-[2.5rem] mb-[20px] text-[#222222] font-[600] leading-[3.125rem]">
            About Us
          </h3>
          <div
            className=" text-[#878787] text-[1.125rem] mb-[1.25rem]">
            <p>
        ...
        ><img src="https://spiruswastha.com/cdn/shop/files/about_us.jpg?v=1733717600&width=700" className='w-full h-full object-contain' /></div>
      </div>
  ...
  >
    <img
      src={src}
      className="object-cover transition-opacity duration-[350ms] ease-[cubic-bezier(0.215,0.61,0.355,1)]"
