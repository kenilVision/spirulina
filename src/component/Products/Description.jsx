      ...
      content: (
        <>
          <p className="mb-[15px] text-[#696969]">
            30-Days Return Policy: Items must be in original condition, unused, with tags and proof of purchase. Contact <a className="underline hover:text-[#018d43]"  href="#">info@spiruswastha.com</a>. to initiate a return.
            </p>
            <p className="mb-[15px] text-[#696969]">
            Refund and Inspection: Refunds are processed within 10 business days after return inspection. Contact us if delays exceed 15 business days.
            </p>
            <p className="mb-[15px] text-[#696969]">
            Shipping and Delivery: Orders ship within 2-7 days with free shipping.
            </p>
        </>
      )
    }
...
<div className='bg-[#f6f6f8] w-full my-[60px]'>
    <div className='w-full max-w-[1440px] mx-auto px-[15px]   lg:pt-[50px]  lg:pb-[30px] ] leading-9.5'>
      {/* Tabs */}
  ...
  <div key={index} className="border border-gray-200 mb-2 lg:hidden rounded">
    <button
      onClick={() => toggleAccordion(index)}
      className="flex items-center justify-between w-full bg-[#a3a3a331] text-[20px]  font-medium text-black gap-3"
      aria-expanded={openIndex === index}
    >
      <span className={`py-[10px] px-5 font-medium ${openIndex === index ? 'text-[#018d43]' : 'text-black'}`}>{item.title}</span>
      <span
