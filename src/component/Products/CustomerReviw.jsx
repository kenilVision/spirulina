      ...
      >
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center pb-[24px]">
          <div className=" w-fit flex justify-center items-center mb-[24px] lg:mb-[0px]  lg:w-1/3">
            <div className="">
              <p className="flex items-center justify-center lg:justify-start gap-x-1 w-auto">
                <svg
              ...
              return (
                ...
                >
                  ...
                  <div className="w-[140px] bg-gray-200 h-4 overflow-hidden">
                    <div
                      className={`h-full ${
                        isHighlighted ? "bg-green-400" : "bg-gray-300"
                      }`}
                  ...
                  {/* Count */}
                  <div className="text-gray-700 w-4 text-right">
                    {rating.count}
                  </div>
                </div>
              );
          ...
          <div className="w-full lg:w-1/3">
            <button
              className="bg-[#018d43] hover:cursor-pointer  text-white text-[16px] py-[10px] px-[20px] w-full md:w-[240px] "
              onClick={toggleForm}
            >
        ...
        <div className="flex justify-center">
          {showForm && (
            <form className="space-y-6 bg-white p-6 w-[568px] text-start text-[18px] text-[#b6b6b6]  ">
              ...
              <div className="flex justify-center gap-x-2 items-center">
                <button
                  type="button"
                  className=" border-2 border-[#018d43] text-[#018d43] px-4 py-2  cursor-pointer"
                  onClick={toggleForm}
                >
                  Cancel review
                </button>
                <button
                  type="submit"
                  value="Submit Review"
                  className="bg-[#018d43] border-2 border-[#018d43] text-white px-4 py-2  cursor-pointer"
                >
                  Submit Review
                </button>
              </div>
        ...
        <div className="flex items-start py-[8px] w-full border-y text-[#018d43] border-[#018d4221] ">
          <select className="text-sm text-[#018d43] bg-white border-0 focus:outline-none focus:border-0  rounded py-[10px]  w-48 cursor-pointer">
