...
{image2 && (
        ...
        />
          ...
          {
           discountPercentage ? (
            <span className='bg-[#018d43] text-white rounded-md h-[22px] text-[13px] px-[6px] min-w-[38px]'>{discountPercentage}%</span>
            ) : (<p></p>)
          }
          ...
          <p className="font-bold truncate">{title}</p>
          {
            orignalPrice && discountedPrice ? (
              <div className="flex text-[1.25rem] leading-10  items-center gap-2 ">
                <span className=" text-[#696969]  line-through"><del>{`₹${orignalPrice}`}</del></span>
