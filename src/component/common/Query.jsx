...
<div>
      <div className={`fixed flex top-0 left-0 w-[calc(100vw-20px)] z-110 sm:w-[340px] h-full shadow-lg transform ${isOpenfilter ? 'translate-x-0' : '-translate-x-full'} transition-transform z-50`}>
