    ...
    <section className="bg-white my-[50px] md:my-[60px]">
      <div className="max-w-[1440px] mx-auto text-[#696969] text-[16px] px-[15px]">
        <div className="mb-8 text-center">
          <h1 className="text-[32px] text-black font-bold">Terms of Service</h1>
        </div>
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-[24px] text-black font-semibold mb-2">1. Eligibility</h2>
          <p>
          ...
          <h2 className="text-[24px] text-black font-semibold mb-2">2. Account Management</h2>
          <p>
          ...
          <h2 className="text-[24px] text-black font-semibold mb-2">3. Use of the Website</h2>
          <p>You may not:</p>
          ...
          <h2 className="text-[24px] text-black font-semibold mb-2">4. Pricing and Product Information</h2>
          <p>
          ...
          <h2 className="text-[24px] text-black font-semibold mb-2">5. Coupons and Promotions</h2>
          <ul className="list-disc pl-[17px]">
          ...
          <h2 className="text-[24px] text-black font-semibold mb-2">6. Loyalty Program</h2>
          <ul className="list-disc pl-[17px]">
          ...
          <h2 className="text-[24px] text-black font-semibold mb-2">7. Shipping and Delivery</h2>
          <p>
            Delivery times are estimated. We’re not responsible for delays outside our control. Refer to our Shipping Policy.
          </p>

          <h2 className="text-[24px] text-black font-semibold mb-2">8. Returns, Refunds, and Cancellations</h2>
          <ul className="list-disc pl-[17px]">
          ...
          <h2 className="text-[24px] text-black font-semibold mb-2">9. User-Generated Content</h2>
          <ul className="list-disc pl-[17px]">
            <li>You give us rights to use and modify your content.</li>
            <li>Do not submit unlawful or abusive material.</li>
          </ul>

          <h2 className="text-[24px] text-black font-semibold mb-2">10. Third-Party Links</h2>
          <p>
            We are not responsible for external content. Use third-party websites at your own risk.
          </p>

          <h2 className="text-[24px] text-black font-semibold mb-2">11. Intellectual Property</h2>
          <p>
            All site content is owned by Spiru Swastha. Reproduction or distribution without permission is prohibited.
          </p>

          <h2 className="text-[24px] text-black font-semibold mb-2">12. Limitation of Liability</h2>
          <ul className="list-disc pl-[17px]">
          ...
          <h2 className="text-[24px] text-black font-semibold mb-2">13. Indemnification</h2>
          <p>
            You agree to defend and indemnify us for any claims from your violation of these terms.
          </p>

          <h2 className="text-[24px] text-black font-semibold mb-2">14. Governing Law and Jurisdiction</h2>
          <p>
            These Terms are governed by Indian law. Disputes will be resolved in Surat, Gujarat.
          </p>

          <h2 className="text-[24px] text-black font-semibold mb-2">15. Modifications to Terms of Use</h2>
          <p>
            We may update these Terms at any time. Continued use of the site confirms your acceptance.
          </p>

          <h2 className="text-[24px] text-black font-semibold mb-2">16. Contact Information</h2>
          <p>
            <strong>Email:</strong>{" "}
