  ...
  return (
    ...
    <div className='max-w-[1650px]  gap-x-[30px] gap-y-[30px]  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 '>
        <div className='' >
            ...
            <p className='mb-[80px]'>
            Swastha for Lifе with Spirulina & Supеrfood Goodnеss
            </p>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M12.008 9.17784L15.169 11.3258C15.3738 11.4454 15.4997 11.6647 15.4997 11.9018C15.4997 12.139 15.3738 12.3583 15.169 12.4778L12.008 14.8278C11.408 15.2348 10.5 14.8878 10.5 14.2518V9.75184C10.5 9.11884 11.409 8.77084 12.008 9.17784Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div className="flex justify-between items-center md:block">
        <h3 className="text-[26px] font-semibold ">Company</h3>
        <button
    ...
    <div className=" w-full ">
      <div className="flex justify-between items-center md:block">
        <h3 className="text-[26px] font-semibold ">Best Selling Products</h3>
        <button
          className="md:hidden focus:outline-none"
    ...
    <div className='py-[7px]  w-full flex justify-center items-center text-white bg-[#018d43] mb-[48px] md:mb-0'>
      <div className='px-[5px] w-auto md:px-[15px] text-[16px] text-center font-semibold flex'>
        <p> © 2025 Spiru Swastha Developed By </p> <a href="#" className=' ps-1 underline '> Visison Infotech</a>
      </div>
    </div>
