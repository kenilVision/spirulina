  ...
  return (
    <>
      ...
      <div className=' flex flex-col  items-center px-[15px] pt-[70px] md:pt-[80px] pb-[10p] lg:pb-[40px] lg:pt-[100px] '>
        ...
        <div className='max-w-[1650px]  gap-x-[0px] gap-y-[10px] md:gap-y-[30px]  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 ' data-aos="fade-up" data-aos-duration="1000"  >
        ...
        <div className='w-full max-w-[1650px] pt-[10px]  md:pt-[20px]' data-aos="fade-up" data-aos-duration="1000"  >
